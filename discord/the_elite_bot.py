...
async def on_ready():
    ...
    data = {"prompt": f"{preprompt}","stop": list(string.printable), "max_tokens": 1}
...
async def on_message(message):
    ...
    if message.author == client.user:
        ...
        data = {
            ...
            "stop": ["###"], "max_tokens": 500, "stream":True
        }
        async with aiohttp.ClientSession() as session:
